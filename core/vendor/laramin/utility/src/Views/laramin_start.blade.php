...
<body>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="alert-area alert alert-danger d-none">
                                        ...
                                        <a href="{{ Laramin\Utility\VugiChugi::splnk() }}"
                                            class="btn btn-outline-light btn-sm" target="_blank">@lang('create  ticket')</a>
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="alert alert-primary" role="alert">
                                        ...
                                        <p class="fs-17 mb-0 word-break-all">@lang('Activation URL'):
                                            {{ Laramin\Utility\Helpmate::appUrl() }}</p>
                                    </div>
                                    ...
                                    <form class="verForm">
                                        ...
                                        <div class="information-form-group d-flex">
                                            ...
                                            <label for="agree" class="agree-label">@lang('I accept the terms of the') <a
                                                    ...
                                                    target="_blank">@lang('Envato Standard License')</a> @lang('as well as the Viserlab terms and conditions.')</label>
                                        </div>
                                        <div class="text-end">
                                            <button type="submit"
                                                class="theme-button choto sbmBtn">@lang('Activate Now')</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <footer class="py-3 text-center bg--dark border-top border--primary">
        <div class="container">
            <p class="m-0 font-weight-bold">&copy;<?php echo Date('Y'); ?> - @lang('All Right Reserved by') <a
                    href="https://viserlab.com/">@lang('ViserLab')</a></p>
        </div>
    </footer>
