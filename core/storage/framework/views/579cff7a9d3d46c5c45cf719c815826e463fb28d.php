<?php
    $aboutContent = getContent('about_2.content', true);
?>
<!-- about-section start -->
        ...
        <div class="row justify-content-center ml-b-30">
            ...
            <div class="col-lg-6 mrb-30">
                <div class="about-thumb-two">
                    <img src="<?php echo e(getImage('assets/images/frontend/about_2/' . @$aboutContent->data_values->image, '555x390')); ?>"
...
<!-- about-section end -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/bplux/core/resources/views/templates/basic/sections/about_2.blade.php ENDPATH**/ ?>