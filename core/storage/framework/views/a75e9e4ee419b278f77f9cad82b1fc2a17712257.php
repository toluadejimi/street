                        ...
                        <ul>
                            <li class="sidebar-menu-item <?php echo e(menuActive('user.service*')); ?>">
                                <a class="nav-link" href="<?php echo e(route('user.services')); ?>">
                                    ...
                                    <span class="menu-title"><?php echo app('translator')->get('Social Media Services'); ?></span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?php echo e(menuActive('user.instant')); ?>">
                                <a class="nav-link" href="<?php echo e(route('user.instant')); ?>">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Instant Verification'); ?></span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('user.instant')); ?>">
                                <a class="nav-link" href="<?php echo e(route('user.instant')); ?>">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('Social Media Account'); ?></span>
                                </a>
                            </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/bplux/core/resources/views/templates/basic/partials/sidenav.blade.php ENDPATH**/ ?>