        ...
        <div class="row justify-content-center ml-b-30">
            <div class="col-lg-6 mrb-30">
                <div class="about-thumb">
                    <img src="<?php echo e(getImage('assets/images/frontend/about_3/' . @$aboutContent->data_values->image, '555x465')); ?>"
            ...
            <div class="col-lg-6 mrb-30">
                <div class="about-content">
                    ...
                    <p> <?php echo @$aboutContent->data_values->description;?></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- about-section end -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/bplux/core/resources/views/templates/basic/sections/about_3.blade.php ENDPATH**/ ?>