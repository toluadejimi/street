...
<?php endif; ?>
    <a href="<?php echo e(route('user.deposit.index')); ?>" class="btn btn-outline--primary">
        ...
        <?php echo app('translator')->get('Fund Wallet Now'); ?>
    </a>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/bplux/core/resources/views/templates/basic/user/deposit_history.blade.php ENDPATH**/ ?>